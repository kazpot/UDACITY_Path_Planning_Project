...
int main() {
    ...
    h.onMessage([&map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy,&lane,&lane_change_wp,&ref_vel](uWS::WebSocket<uWS::SERVER> *ws, char *data, long unsigned int length, uWS::OpCode opCode) {
